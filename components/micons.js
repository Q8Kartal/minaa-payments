...
const MICONS = {
  ...
  /* ── The language switch's two marks ──────────────────────────────────────
     NOT from the Micons library and not typed text: these are Ahmad's own
     flattened Unions from the Components file -- the letter with its two
     sparkles as one shape -- exported with Figma's own SVG exporter and edited
     the same two ways every other glyph here was: the paint swapped for
     currentColor, the wrapping clipPath dropped.

     They carry their own viewBox because they are 33 x 26.169 rather than
     square, and the sparkles sit at the corners where a 24-box squeeze would
     show. The colour comes from whichever half of the track they sit in --
     see .ls-en / .ls-ar in the bridge.

       langEn   Figma 381:191   the E, shown while Arabic is active
       langAr   Figma 381:200   the \u0636, shown while English is active */
  langEn: { viewBox: '0 0 33.0003 26.1689', body: '<path d="M26.3756 19.2897C26.4685 19.2053 26.659 19.3109 27.0377 19.5202L27.2662 19.6442L28.0797 20.0944C28.8293 20.5086 29.2055 20.7161 29.6178 20.7321C30.0298 20.7477 30.4219 20.5702 31.2037 20.2155L32.0563 19.8288L32.5524 19.6061C32.7791 19.5094 32.9075 19.4754 32.9713 19.5446C33.0558 19.6369 32.9486 19.8274 32.7379 20.2067L32.6139 20.4342L32.1588 21.2516C31.7418 22.0022 31.534 22.3787 31.5162 22.7907C31.4988 23.2029 31.6748 23.5939 32.027 24.3747L32.6315 25.7204C32.7273 25.9464 32.7598 26.075 32.691 26.1393C32.6215 26.2031 32.4963 26.1602 32.2789 26.0465L31.8024 25.7848L30.9869 25.3337L30.5006 25.069C30.0523 24.8307 29.761 24.7092 29.4488 24.6969C29.0366 24.681 28.6441 24.8577 27.8619 25.2126L27.0123 25.5983L26.775 25.7047L26.5143 25.8229C26.325 25.9037 26.2042 25.9389 26.1324 25.9088L26.0953 25.8835C26.0107 25.7911 26.1177 25.6011 26.3287 25.2213L26.4547 24.9938L26.9069 24.1774C27.324 23.4265 27.5328 23.0496 27.5504 22.6374C27.5635 22.3257 27.4668 22.0253 27.2662 21.5602L27.0406 21.0534L26.6578 20.2047L26.5514 19.9684C26.3954 19.6225 26.3066 19.4273 26.3492 19.3268L26.3756 19.2897ZM20.6715 3.63834C23.3999 3.63893 23.3999 7.64166 20.6715 7.64225H15.1051V11.1051H19.4449C22.1736 11.1055 22.1736 15.1077 19.4449 15.1081H15.1051V18.571H20.9235C23.6521 18.5714 23.6521 22.5745 20.9235 22.5749H13.3014C11.498 22.5749 10.488 21.5286 10.4879 19.6891V6.45182C10.4879 4.6484 11.5341 3.63834 13.3736 3.63834H20.6715ZM1.26525 0.0104119C1.40259 -0.0447412 1.61221 0.121699 2.02892 0.450842L2.30431 0.665685C2.96058 1.1811 3.33638 1.45348 3.76818 1.57584L4.12658 1.65006L4.5133 1.66373C4.91727 1.64048 5.39811 1.51112 6.16466 1.30533L6.75548 1.16373C6.89518 1.14298 6.98549 1.15268 7.03771 1.20475C7.06053 1.22806 7.07986 1.25763 7.0924 1.28776L7.10314 1.34342C7.1042 1.48134 6.94191 1.68663 6.65587 2.05045C6.00232 2.88174 5.67529 3.30013 5.53869 3.78873C5.50595 3.9061 5.48108 4.0272 5.46544 4.14811C5.40069 4.65159 5.53978 5.16571 5.81701 6.18912L
 15.266 12.3827 14.3353 11.8307 11.279C11.1665 8.72335 14.5708 7.885 15.2458 10.3688L15.4088 11.1354H15.5827C20.2853 7.3017 23.2412 5.40025 25.6335 5.40005ZM24.2838 9.17251C23.0366 9.17266 21.4208 9.91928 19.4274 11.0846C22.0853 10.9824 24.0385 10.7366 26.2262 10.2868C25.7867 9.4898 25.1116 9.1726 24.2838 9.17251ZM1.26529 0.0104001C1.40264 -0.0447158 1.61229 0.12171 2.02896 0.45083L2.30435 0.665674C2.96067 1.18112 3.3364 1.45347 3.76822 1.57583L4.12662 1.65005L4.51334 1.66372C4.91731 1.64047 5.39815 1.51111 6.16471 1.30532L6.75553 1.16372C6.89502 1.143 6.98551 1.15187 7.03775 1.20376C7.06067 1.22711 7.07986 1.25752 7.09244 1.28774L7.10318 1.34341C7.10424 1.48133 6.94196 1.6866 6.65592 2.05044C6.00234 2.88176 5.67533 3.3001 5.53873 3.78872C5.50603 3.90596 5.48112 4.02635 5.46549 4.14712C5.40058 4.65077 5.53972 5.16532 5.81705 6.18911L5.9606 6.78188C5.97643 6.8863 5.9748 6.96349 5.95182 7.01724L5.92057 7.06411C5.8973 7.087 5.86871 7.10631 5.83853 7.1188L5.78189 7.12954C5.72332 7.12962 5.65223 7.10038 5.56217 7.04458L5.07486 6.67935C4.24232 6.02175 3.82331 5.69266 3.33463 5.55435C3.21725 5.52116 3.09709 5.49617 2.97623 5.48013C2.53182 5.42129 2.08017 5.51889 1.27701 5.73208L0.93912 5.82388C0.491716 5.94399 0.239412 6.01191 0.112948 5.95669L0.0650968 5.92544C0.0423494 5.90203 0.0228266 5.87258 0.0104093 5.84243C-0.0444479 5.70462 0.11991 5.49472 0.446933 5.07876C1.10065 4.24727 1.42869 3.82941 1.5651 3.34048C1.59772 3.22326 1.62179 3.10282 1.63736 2.98208C1.70197 2.47858 1.5641 1.96387 1.28678 0.940088C1.14793 0.427531 1.07731 0.169527 1.18228 0.0650876C1.20564 0.042225 1.23507 0.0227983 1.26529 0.0104001ZM20.4977 1.86001C21.6325 1.86001 22.5523 2.74948 22.5524 3.8229C22.5523 4.92695 21.6325 5.81606 20.4977 5.81606C19.3632 5.81584 18.4432 4.92682 18.443 3.8229C18.4431 2.74962 19.3631 1.86023 20.4977 1.86001Z" fill="currentColor"/>' },
  /* ── The button family ─────────────────────────────────────────────────
     Copied from the button pages' own sprite so the two libraries cannot
     show different glyphs for the same thing: `button` and `iconbutton`
     title entries 39 and 40, and `search` is the icon those specimens
     carry -- the same one buttons.html uses for its leading and trailing
...
(function injectSprite() {
  ...
  /* An entry is normally just its path data on the library's 24-unit grid. The
     two language marks are not: they are Ahmad's own flattened artwork, 33 x
     26.169, and squeezing them into a 24 box would distort the sparkles. So an
     entry may also be { viewBox, body } and bring its own frame. */
  svg.innerHTML = Object.entries(MICONS)
    .map(([k, v]) => {
      const body = typeof v === 'string' ? v : v.body;
      const box = typeof v === 'string' ? '0 0 24 24' : v.viewBox;
      return '<symbol id="mi-' + k + '" viewBox="' + box + '" fill="none">' + body + '</symbol>';
    })
    .join('');
